...
// In charge of coordinates, info, etc. of camera view
...
//after tapped. get info of place
...
- (void)generateGeoLocations {
    ...
    for(Place *place in _locations) {
        ...
        NSLog(@"place: %@, type: %@", place, place.type);
        //more code later
        MarkerView *markerView = [[MarkerView alloc] initWithCoordinate:coordinate type:place.type delegate:self];
